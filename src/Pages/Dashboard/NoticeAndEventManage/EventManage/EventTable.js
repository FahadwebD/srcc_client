...
export default function EventTable({staffs , setStaffs,handleStaffEdit}) {
  ...
  const handleChangeRowsPerPage = (event) => {
    ...
    const handleStaffDelete = (_id) =>{
        ...
        const url=`https://serversrcnc.vercel.app/event/${_id}`
        fetch(url, {
          method:'DELETE',
          headers: {
        ...
        <tbody>
          {(rowsPerPage > 0
            ...
            <tr key={row._id}>
              ...
              <td style={{ width: 420 }} align="right">
                {row.description}
              </td>
