...
const StudentManage = () => {
    ...
    useEffect( () =>{
        fetch(`https://serversrcnc-production-97a5.up.railway.app/student/home?page=${page}&size=${size}`)
        .then(res => res.json())
        .then(data => {
        setStudents(data)
    ...
    useEffect( () =>{
        fetch('https://serversrcnc-production-97a5.up.railway.app/studentCount')
        .then(res => res.json())
        .then(data =>{
 ...
 function updateForm(value) {
  return setForm((prev) => {
    ...
    const handleStaffSubmit = e => {
       ...
       fetch('https://serversrcnc-production-97a5.up.railway.app/student/edit', {
           method: 'PATCH',
           headers: {
  ...
  const handleStudentDelete = (_id) =>{
    ...
    const url=`https://serversrcnc-production-97a5.up.railway.app/student/${_id}`
    fetch(url, {
      method:'DELETE',
