...
const StaffManage = () => {
    ...
    const handleClose = () => {
      ...
      const handleEdit = (_id) =>{
        ...
        fetch(`https://serversrcnc-production-97a5.up.railway.app/staff/${_id}`)
        .then(res=>res.json())
        .then(record => {
          setForm(record)
        setId(record._id)})
    ...
    const handleStaffSubmit = e => {
       ...
       fetch(`https://serversrcnc-production-97a5.up.railway.app/staff/edit/${id}`, {
           method: 'PATCH',
    ...
    const handleDelete = (_id) =>{
      ...
      const url=`https://serversrcnc-production-97a5.up.railway.app/staff/${_id}`
      fetch(url, {
        method:'DELETE',
